...
1. **Создать AuthorLayout** - Layout с боковой навигацией
2. **Создать константы** - AUTHOR_NAVIGATION
3. **Добавить роуты** - /author/courses, /author/lessons

### 15.2 Краткосрочные (1-2 недели)

1. **Страница курсов автора** - список, создание, редактирование
2. **Страница уроков автора** - список, создание, редактирование
3. **Редактор контента** - базовый WYSIWYG
