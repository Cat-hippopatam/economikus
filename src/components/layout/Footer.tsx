...
<Paper 
 ...
 >
<Text size="xs" c="dimmed" style={{ color: 'rgba(255,255,255,0.6)' }} ta="center">
<Text component="span" fw={600}>⚠️ Учебный (дипломный) проект</Text>
 {' '}&middot;{' '}
 Все данные используются только для демонстрации
 {' '}&middot;{' '}
 Реальные платежи не принимаются
</Text>
</Paper>

<Group justify="space-between" wrap="wrap" gap="sm" mt="md">
