...
function MarkdownRenderer({ content }: { content: string }) {
  return (
    <Box 
      ...
      styles={{
        '.markdown-content h1': { marginTop: 24, marginBottom: 16 },
        '.markdown-content h2': { marginTop: 20, marginBottom: 12 },
        '.markdown-content h3': { marginTop: 16, marginBottom: 8 },
        '.markdown-content p': { marginBottom: 12 },
        '.markdown-content ul': { marginLeft: 24, marginBottom: 12 },
        '.markdown-content ol': { marginLeft: 24, marginBottom: 12 },
        '.markdown-content li': { marginBottom: 4 },
        ...
        '.markdown-content table': { width: '100%', borderCollapse: 'collapse', marginBottom: 16 },
        '.markdown-content th, .markdown-content td': { border: '1px solid var(--mantine-color-gray-3)', padding: '8px 12px' },
        '.markdown-content th': { backgroundColor: 'var(--mantine-color-gray-1)' },
        '.markdown-content img': { maxWidth: '100%', borderRadius: 8 },
        '.markdown-content a': { color: 'var(--mantine-color-blue-6)', textDecoration: 'underline' },
      }}
    >
      <ReactMarkdown
        ...
        components={{
          ...
          blockquote: ({ children }) => (
            <Blockquote color="blue" icon={null} mt="md" mb="md" styles={{ inner: { lineHeight: 1.8 } }}>
              {children}
            </Blockquote>
          ),
...
function LessonContent({ lesson, onMarkCompleted }: { lesson: any; onMarkCompleted: () => void }) {
        ...
        <Group align="flex-start" gap="xl" wrap="nowrap">
          ...
          <Box style={{ flex: 1 }}>
            <Stack gap="lg">
              ...
              {/* Контент */}
              <LessonContent lesson={lesson} onMarkCompleted={markCompleted} />
