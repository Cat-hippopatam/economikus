...
<Checkbox 
 label={
<Text size="sm">
 Я ознакомлен с тем, что сайт является{' '}
<a href="/terms" target="_blank" rel="noopener noreferrer" style={{ color: '#2A9D8F' }}>
 учебным проектом
</a>
{' '}и согласен на обработку вводимых данных в демонстрационных целях
</Text>
} 
