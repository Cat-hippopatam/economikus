...
export const APP_CONFIG = {
  ...
  version: '1.0.0',
  // apiUrl выбирается в зависимости от окружения:
  // - в development (не PROD) используем относительный путь '/api' (dev server proxy)
  // - в production используем VITE_API_URL если задан, иначе '/api' (monolithic-деплой)
